<!DOCTYPE HTML>
<!--
        IT Services - Weverton S Lima
        thanks to html5up.net | @ajlkn
        Free for personal and commercial use under the CCA 3.0 license
-->
<html>
    <head>
        <title>IT Services - Unix.Local</title>
        <meta charset="utf-8" />
    ...
    <body class="landing">
        <div id="page-wrapper">
            ...
            <header id="header">
                ...
                <nav id="nav">
                    ...
                    <ul>
                        ...
                        <li><a href="/client" class="button special">Clientes</a></li>
                    </ul>
                    <!-- Fim menu do topo -->
                </nav>
            </header>
            ...
            <p>Solicite um orçamento ou escolha dentre nossas soluções pré-desenvolvidas do portfólio.</p>
            </header>
            <form method = "post" action = "/contact" class = "container 50%">
            <div class = "row uniform 50%">
            <div class = "8u 12u$(xsmall)"><input type = "email" name = "email" id = "email" placeholder = "Seu E-Mail" /></div>
            <div class = "4u$ 12u$(xsmall)"><input type = "submit" value = "Começar" class = "fit special" /></div>
            </div>
            </form>
            </div>
            </section>
