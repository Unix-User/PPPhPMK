                ...
                <a class="clean" href="/product/{{  $product->id }}/show">
                    ...
                    <div class="card-footer">
                        ...
                        <small class="text-muted float-right">
                            ...
                            <a class="clean icon solid fa-trash" href="/product/{{ $product->id }}/delete"
                                onclick="return confirm('Deletar esse intem?')"></a>
                            @else
                            <a class="clean ask icon solid fa-shopping-cart" onclick=""
                                href="/product/{{ $product->id }}/select"></a>
                            @endif
                        </small>
                    </div>
                </a>
