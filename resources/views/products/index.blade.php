                ...
                <a class="clean" href="/product/{{  $product->id; }}/show">
                    ...
                    <div class="card-footer">
                        ...
                        <small class="text-muted float-right">
                            ...
                            @else
                            <a class="clean icon solid fa-shopping-cart" onclick="return confirm('Tem certeza que deseja mudar o seu plano? Ao confirmar seu usuário será designado para o time tecnico especifcado no plano selecionado e um novo contrato será gerado para o seu plano. A ativação será processada ao finalizar o pagamento!')" href="/product/{{ $product->id }}/select"></a>
                            @endif
                        </small>
                    </div>
                </a>
