...
<div class="col-xs-12 col-xs-offset-0">
    <div>
        <div class="panel-heading">
            <h3 class="panel-title">Criar produto</h3>
        </div>
        <div class="panel-body">
            <form action="/product/store" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                @csrf
                @method('POST')
                <div class="form-group row">
                    <div class="8u 6u(medium) 12u$(xsmall) @if($errors->has('name')) has-error @endif">
                        <label for="name" class="control-label">Produto</label>
                        <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="Produto" required>
